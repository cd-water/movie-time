...
(
    ...
    fan_count      INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '粉丝数',
    follower_count INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '关注数',
    create_time    DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    update_time    DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
(
    ...
    type         VARCHAR(32) COMMENT '类型，用英文逗号分隔',
    ...
    actors       VARCHAR(255) COMMENT '主演列表，用英文逗号分隔',
...
(
    ...
    district    VARCHAR(32)    NOT NULL COMMENT '区域',
    longitude   DECIMAL(10, 7) NOT NULL COMMENT '经度',
    latitude    DECIMAL(9, 7)  NOT NULL COMMENT '纬度',
    phone       VARCHAR(20)    NOT NULL COMMENT '联系电话',
    min_price   DECIMAL(10, 2) NOT NULL COMMENT '最低票价',
...
(
    id          BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT COMMENT '用户关注id，主键',
